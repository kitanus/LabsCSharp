...
namespace pOOP_Lab_Csharp
{
    ...
    public partial class frmMain : Form
    {
        ...
        public frmMain() // конструктор данного класса
        {
        ...
        private void pboxWorkSpace_Paint(object sender, PaintEventArgs e)
        {
            ...
            objFigureOne.point = objTrajectory.getTrajectoryPoints(); // передача свойству point обьекта objFigureOne возвращаемое значение метода getTrajectoryPoints() обьекта objTrajectory
        ...
        private void tbAngleFigure_ValueChanged(object sender, EventArgs e)
        {
            ...
            objFigureOne.angle = (double)(2 * Math.PI * tbAngleFigure.Value) / (double)(tbAngleFigure.Maximum - tbAngleFigure.Minimum);
            objFigureTwo.angle = (double)(2*Math.PI*tbAngleFigure.Value) / (double)(tbAngleFigure.Maximum - tbAngleFigure.Minimum); 
        }
    }
}
