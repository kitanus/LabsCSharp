...
namespace pOOP_Lab_Csharp
{
    ...
    public partial class frmMain : Form
    {
        ...
        {
            e.Graphics.FillRectangle(new SolidBrush(backColor), new Rectangle(0, 0, pboxWorkSpace.Height, pboxWorkSpace.Width)); // Очистить поле белым цветом
        ...
        {
            //	Возвращает или задает значение, указывающее, может ли пользователь использовать диалоговое окно 
            // для определения собственных цветов.
